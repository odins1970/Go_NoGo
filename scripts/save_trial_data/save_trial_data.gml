...
function save_trial_data()
{
  ...
  file_text_write_string(summary_file, "Код,Общее количество испытаний (шт),Количество правильных ответов (шт),Концентрация_Серия правильных в среднем (шт),Медианное TR общее (мс),Медианное TR контрольное (мс),Точность (%),Ложные срабатывания (шт),Пропуски (шт),Испытания Go (шт),Испытания NoGo (шт),Прайм зеленый (шт),Прайм красный (шт),Прайм черная (шт),Переключаемость_отношение TR_медиан  между сменой и повторением стимула (%),TR_медиан прайм Подсказка,TR_медиан прайм Помеха,Помехоустойчивость по TR_медиан подсказка_помеха %,Порог Адаптации к стимулу (мс),Средний размер зрачка в ожидании (пикс),Средний размер зрачка в прайм (пикс),Средний размер зрачка цель (пикс),Сила изменения зрачка(пикс),Точность средняя при подсказке(%),Точность средняя при помехе(%), Помехоустойчивость в точности Подсказка_Помеха\n");
