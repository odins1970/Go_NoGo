...
#define eyet_init
/// @description  (url, port, on_data:script<json_map;json_str>, ?async:bool, ?on_connect:script<success:bool>)
/// @param url
/// @param  port
/// @param  on_data:script<json_map;json_str>
/// @param  ?async:bool
/// @param  ?on_connect:script<success:bool>
...
#define eyet_send
/// @description  (json_string_or_map)
/// @param json_string_or_map
